...
Para calcular la resistencia efectiva de un transistor de tamaño mínimo de la tecnología del curso, se hizo uso de las ecuaciones provistas en la sección 4.3.7 de [1], las cuales se muestran a continuación
 ...
 $$R_{eff}=\frac{V_{DD}}{2I_{dsat}}=\frac{V_{DD}}{2I_{ON}}$$
 
 $$R_{eff}=\frac{V_{DD}}{I_{ON}+I_{OFF}}$$
...
Segun la tabla proporcionada en [2]; $C_{OX}$ es 8.46 fF/um para NMOS y 8.91fF/um para el PMOS, y $C_{OV}$ es 0.33fF/um2 para NMOS y 0.32fF/um2 para PMOS. $L_{dib}$ es 0.18 y $W_{dib}$ es 0.22um, para ambos transistores (NMOS y PMOS). Obteniendo los siguientes resultados
...
Para determinar el Beta del transistor se utilizó la ecuación de un transistor en zona de saturación:
